        ...
        <div className="mt-8">
          <form onSubmit={(e) => handleSubmit(e)}>
            ...
            <div className="flex w-full">
              <button
                type="submit"
                className="py-2 px-4  bg-cust_tertiary hover:bg-cust_primary focus:ring-purple-500 focus:ring-offset-purple-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg "
              >
                Login
              </button>
            </div>
